Shader "Custom/movement"
{
    Properties
    {
        ...
        AnimatedMouvementUV_X_1("AnimMovementUV_X_1",Range(-1,1))=0.268
        AnimatedMouvementUV_Y_1("AnimMovementUV_Y_1",Range(-1,1))=0.554
        AnimatedMouvementUV_Speed_1("AnimMovementUV_Speed_1",Range(-1,1))=0.239
